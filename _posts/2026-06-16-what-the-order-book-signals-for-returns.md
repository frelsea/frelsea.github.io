---
layout: post
title: "What the Order Book Signals for Returns"
date: 2026-06-16
published: true
...
key_points:
  ...
  - "Secondhand prices track earnings at an 87 percent correlation, yet at cyclical peaks buyers have paid more than 100 percent above fundamental value."
  - "Industry investment is negatively correlated with future returns, at about minus 0.35, so a heavy order book forecasts weak returns."
  - "Outstanding orders ran below 10 percent of the fleet in 2001 and above 75 percent by August 2008, before returns fell 76 percent in the year to December 2008."
  - "Heavy demolition forecasts high subsequent returns, which favours acquiring tonnage when industry ordering is subdued."
---
...
{% include order-book-returns-chart.html %}
...
## Prices follow earnings, then exceed them
...
## The order book carries the signal
...
{% include shipping-cycle-loop.html %}
