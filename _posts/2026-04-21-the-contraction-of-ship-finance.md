...
key_points:
  ...
  - "Chinese state-backed lessors filled much of the gap and now finance a fleet equal to roughly 9 percent of global deadweight, concentrating the market in one national system."
  - "A meaningful equity stake in a single-vessel SPV still runs USD 5 to 25 million, leaving mid-size and independent owners short of competitive renewal capital."
  - "Decarbonisation is estimated to need USD 1.2 to 1.6 trillion by 2050, beyond what the current bank-and-leasing structure delivers."
  - "Maritime funds, shipping bonds and tokenised vessel economics each address part of the gap, and each carries structural limits; the digital structures remain unproven."
---
...
{% include ship-finance-contraction-chart.html %}

## The banks have stepped back
...
## Chinese leasing has filled part of the gap
...
## The squeeze on independent owners
...
## The existing menu, and where it falls short
...
## New mechanisms remain unproven
